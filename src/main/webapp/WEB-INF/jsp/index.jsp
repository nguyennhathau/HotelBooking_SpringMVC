            ...
            <div class="container-fluid">
                <div class="row text-center">
                    <div class="col-lg-3 col-md-3 wow fadeInLeft" data-wow-delay="1.0s" >
                        <a href="getAllRoom"><img class="image" style="width: 80%;height: 230px;" src="rooms/hinh1.jpg" alt=""></a>
                        <h4> ROOMS</h4>
                        <hr>
                    ...
                    <div class="col-lg-4 col-md-4 text-center" style="margin: 40px auto;"><a href="getAllRoom" style="border: 1px solid black;color: #4c4c4c; font-weight: bold; font-size: 18px; padding: 20px 30px;">VIEW ALL ROOMS</a></div>
                </div>
            </div>
